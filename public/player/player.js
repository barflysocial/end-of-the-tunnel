...
const STORY_BRIEFINGS = {
  training: [
    ['0:00–0:45','Case File 1: Peacock Alley','Dr. Malcolm Vire is found dead near the restricted tunnel door during a historic preview.','This is the opening chapter. Solve the first murder and prove the tunnel has been used recently.'],
    ['0:45–1:30','Start With the Room','A blackout, a champagne toast, and a moved service rope create the first evidence chain.','Training Detective keeps the deduction direct: method, access, motive, proof.'],
    ['1:30–2:15','The Forged Letter','Celeste Moreau, the stage cue, and the wrong glass point toward a modern fraud hidden behind an old rumor.','The old story is useful because it distracts people from the physical evidence.'],
    ['2:15–3:30','What This Chapter Adds','This case does not end the Tunnel story. It proves the passage was opened recently.','That discovery sends the investigation toward the ledger.'],
    ['3:30–4:15','What to Compare','Compare the glass, phone calls, photos, browser searches, and security export.','The correct answer should explain the murder and the first larger clue.'],
    ['4:15–5:00','Your Mission','Close the first case file, then watch what it unlocks.','The End of the Tunnel is one larger story told through progressive case files.']
  ],
  rookie: [
    ['0:00–0:45','Case File 2: The Missing Ledger','After Malcolm’s murder, archive courier Isaac Bell dies near the service records.','The recovered hotel ledger now points to a missing Page 47.'],
    ['0:45–1:30','The Second Death','The scene looks like a fall, but the coffee, stairwell, and scanner logs disagree.','Rookie Detective adds a deeper timeline and a document trail.'],
    ['1:30–2:15','Page 47','The missing page translates old hotel service codes into modern dead-drop instructions.','The ledger is not just history. It is a working codebook.'],
    ['2:15–3:30','What This Chapter Adds','Nora Vale’s archive access reveals that someone is using old records to run present-day exchanges.','The case moves from an opened door to a coded operation.'],
    ['3:30–4:15','What to Compare','Compare keycard pings, scanner timestamps, fibers, coffee, and deleted messages.','The right answer should explain why one page was worth killing for.'],
    ['4:15–5:00','Your Mission','Do not treat the ledger as background lore. Treat it as active evidence.','The next chapter follows the code to the King Hotel envelope.']
  ],
  junior: [
    ['0:00–0:45','Case File 3: The King Hotel Envelope','Page 47 leads to a sealed envelope marked KING HOTEL — DO NOT DELIVER. Courier Andre Lavigne dies during the reveal.','Junior Detective makes the evidence itself dangerous.'],
    ['0:45–1:30','The Seal','The envelope matters because the wax, stamp, and gloves reveal who handled the item before the victim.','This chapter asks you to separate historic prop from modern weapon.'],
    ['1:30–2:15','The Duplicate Card','The King Hotel side was supposed to be sealed, but a duplicate access credential says otherwise.','Access becomes more complicated because someone can control the door system.'],
    ['2:15–3:30','What This Chapter Adds','Julian March’s duplicate-card scheme proves the King Hotel side is a live entrance, not a dead end.','The larger story now has a gatekeeper.'],
    ['3:30–4:15','What to Compare','Compare wax residue, gloves, access-card exports, room-service stamps, and payment trails.','The right answer should explain weapon, access, and why the envelope had to stay closed.'],
    ['4:15–5:00','Your Mission','Solve the courier’s death, then connect the envelope to the larger route.','The next chapter follows the route into the Heidelberg side.']
  ],
  detective: [
    ['0:00–0:45','Case File 4: The Heidelberg Escape','Collector Bennett Clay dies in what looks like a renovation accident in the Heidelberg service lift.','Detective level turns the tunnel into a logistics map.'],
    ['0:45–1:30','The Work Order','A modified work order, cut ground wire, and tile dust suggest the accident was staged.','This chapter rewards technical comparison over obvious suspicion.'],
    ['1:30–2:15','The Artifact Route','Forged artifacts and blackmail files appear to move through the renovation corridor.','The famous escape route is being rebuilt as a transport path.'],
    ['2:15–3:30','What This Chapter Adds','Rhett Boudreaux shows how physical evidence could move through the Heidelberg side without the lobby noticing.','The larger story now has infrastructure.'],
    ['3:30–4:15','What to Compare','Compare phone silence, work-order metadata, boot dust, service-lift evidence, and payments.','The right answer should explain how evidence moved, not just who looked guilty.'],
    ['4:15–5:00','Your Mission','Solve the staged accident and identify what the route was built to hide.','The final chapter asks who controlled the entire system.']
  ],
  senior: [
    ['0:00–0:45','Case File 5: The Door That Was Never Sealed','Blackmail broker Darius Vale dies inside a private service room after threatening to expose every previous case file.','Senior Detective is the full conspiracy chapter.'],
    ['0:45–1:30','All Roads Point Back','The ledger page, envelope, access cards, work order, and payments now form one map.','This case is harder because every previous layer matters.'],
    ['1:30–2:15','The Bar-Side Lock','The final death was not caused by someone running through the tunnel. It was caused by someone controlling the door from inside The Tunnel.','Authority becomes the strongest evidence.'],
    ['2:15–3:30','What This Chapter Adds','Vivian Cross controls the venue, the locks, the public story, and the business built around the legend.','The tunnel was never sealed. It was managed.'],
    ['3:30–4:15','What to Compare','Compare lock logs, CO evidence, sponsor accounts, deleted calls, and the pattern across all earlier cases.','The correct answer should connect every chapter without coincidence.'],
    ['4:15–5:00','Your Mission','Close the full arc by identifying the person who controlled the secret after the first murder.','At the end of the tunnel is not a ghost. It is a system.']
  ]
};
