...
function renderSession(info) {
  sessionInfo = info;
  $('sessionTitle').textContent = info.tableName || 'The End of the Tunnel Check-In';
  $('sessionMeta').textContent = `${info.truthPackTitle || 'The End of the Tunnel'} · ${info.eventDateLabel || 'Date TBD'} · ${info.eventTimeLabel || 'Time TBD'}`;
